...
file1=os.stat('input.txt').st_size
file2=os.stat('dictionary.txt').st_size
l = open("size.txt","w")  
#print(file_stats)
#print(file1)
compsize=(s/8)+encl+(file2/8)
#print(compsize)
compratio=(file1-compsize)/file1
l.write("\nSize of compressed Text : "+str(compsize)+" bytes\n")
l.write("Compression ratio achieved = "+str(round(compratio*100,2))+"%")
l.close()
